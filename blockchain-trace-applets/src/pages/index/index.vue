<template>
  <div style="padding-top: 50px;">
    ...
    >
      <view class="content">基于区块链的商品溯源平台，凭借着区块链的不可篡改，去中心化，可追溯特性，让每件商品从加工到售卖整个过程透明化</view>
    </l-card>
    ...
    <div style="padding-top:15px;padding-bottom: 15px;">
      <l-notice-bar :show="true" type="roll" speed="10000">最新区块:{{blockInfo.data.header.data_hash }}</l-notice-bar>
    </div>
    ...
    <div style="padding-bottom: 15px;">
      <div>
        <l-search-bar
          shape="circle"
          @linconfirm="queryInfo"
          @linchange="getTraceId"
          placeholder="溯源ID"
          :show-cancel="false"
        />
      </div>
