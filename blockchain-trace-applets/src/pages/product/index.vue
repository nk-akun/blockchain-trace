<template>
  <div>
    ...
    <div
      ...
      v-for="(detail,index) in cropsProcessDetailsArray"
      :key="index"
    >
      <i-card :title="detail.crops_grow_id" :thumb="detail.crops_grow_photo_url">
        <l-album :urls="photo"></l-album>
        <view slot="footer">
          <i-input :value="detail.grow_status" title="生长情况" disabled />
        </view>
        <view slot="footer">
          <i-input :value="detail.illumination_status" title="光照情况" disabled />
        </view>
        <view slot="footer">
          <i-input :value="detail.water_content" title="水分" disabled />
        </view>
        <view slot="footer">
          <i-input :value="detail.temperature" title="温度" disabled />
        </view>
        <view slot="footer">
          <i-input :value="detail.record_time" title="记录时间" disabled />
        </view>
        <view slot="footer">
          <i-input :value="detail.remarks" title="备注" disabled />
        </view>
      </i-card>
    </div>
    <br />
    ...
    <div v-show="showMaching" style="padding-top: 1.25rem;">
      <i-card :title="machingInfo.machining_id" :thumb="machingInfo.testing_photo_url">
        <view slot="footer">
          <i-input :value="machingInfo.leader" title="负责人" disabled />
        </view>
        <view slot="footer">
        ...
        <view slot="footer">
          <i-input :value="machingInfo.out_factory_time" title="出厂时间" disabled />
        </view>
        <view slot="footer">
          <i-input :value="machingInfo.testing_result" title="检测结果" disabled />
        </view>
        <view slot="footer">
          <i-input :value="machingInfo.remarks" title="备注" disabled />
        </view>
      </i-card>
    </div>
    ...
    <div
      v-show="showProcess"
      style="padding-top: 1.25rem;"
      v-for="(detail,index) in operationArray"
      :key="index"
    >
      <i-card :title="detail.operation_id">
        <view slot="footer">
          <i-input :value="detail.operation_people_name" title="员工" disabled />
        </view>
        <view slot="footer">
          <i-input :value="detail.operation_people_tel" title="电话" disabled />
        </view>
        <view slot="footer">
          <i-input :value="detail.work_content" title="操作内容" disabled />
        </view>
        <view slot="footer">
          <i-input :value="detail.time" title="时间" disabled />
        </view>
        <view slot="footer">
          <i-input :value="detail.remarks" title="备注" disabled />
        </view>
    ...
    <div v-show="showCropsInfo" style="padding-top: 1.25rem;">
      <i-card :title="cropsDetails.crops_id">
        <view slot="footer">
          <i-input :value="cropsDetails.crops_name" title="原料名称" disabled />
        </view>
        <view slot="footer">
          <i-input :value="cropsDetails.farmer_name" title="供应商名称" disabled />
        </view>
        <view slot="footer">
          <i-input :value="cropsDetails.farmer_tel" title="电话" disabled />
        </view>
        <view slot="footer">
          <i-input :value="cropsDetails.address" title="地址" disabled />
        </view>
        <view slot="footer">
          <i-input :value="cropsDetails.plant_mode" title="采集方式" disabled />
        </view>
        <view slot="footer">
          <i-input :value="cropsDetails.year" title="生产年份" disabled />
        </view>
        <view slot="footer">
          <i-input :value="cropsDetails.bagging_status" title="危险品" disabled />
        </view>
        <view slot="footer">
          <i-input :value="cropsDetails.fertilizer_name" title="添加剂" disabled />
        </view>
        <view slot="footer">
          <i-input :value="cropsDetails.grow_seedlings_cycle" title="质量标准" disabled />
        </view>
        <view slot="footer">
          <i-input :value="cropsDetails.irrigation_cycle" title="处理步骤" disabled />
        </view>
        <view slot="footer">
          <i-input :value="cropsDetails.weed_cycle" title="贮藏条件" disabled />
        </view>
        <view slot="footer">
          <i-input :value="cropsDetails.apply_fertilizer_cycle" title="物态状态" disabled />
        </view>
        <view slot="footer">
          <i-input :value="cropsDetails.register_time" title="注册时间" disabled />
        </view>
        <view slot="footer">
          <i-input :value="cropsDetails.remarks" title="其他信息" disabled />
        </view>
      </i-card>
    </div>
  </div>
