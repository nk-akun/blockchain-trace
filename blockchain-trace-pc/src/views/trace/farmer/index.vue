<template>
  <div class="app-container">
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" icon="el-icon-plus" size="mini" @click="handleAdd">添加原材料</el-button>
      </el-col>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button
            ...
            size="mini"
            type="text"
            @click="noticeTrasport(scope.row)"
          >通知运输</el-button>
    ...
    <el-drawer
      size="80%"
      :visible.sync="cropsProcessDetaiDialog"
      :show-close="false"
      :with-header="false"
    >
      ...
      <el-table v-loading="loading" :data="cropsProcessDetailsArray">
        ...
        <el-table-column label="图片" class="demo-image__preview">
          <template slot-scope="scope">
            <el-image
              :preview-src-list="scope.row.crops_grow_photo_url"
              :src="scope.row.crops_grow_photo_url"
